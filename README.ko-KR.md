...
- **F12**는 녹화를 시작하고 다시 누르면 중단·저장합니다. **Ctrl+Shift+F12**는 저장하지 않고 취소하며, 단축키는 설정에서 변경하거나 끌 수 있습니다.
- 톱니바퀴 메뉴에서 마우스 커서 포함 여부와 즉시/3초/5초 시작 지연을 선택할 수 있습니다.
- 저장 완료 문구를 5초 안에 누르면 결과 파일을 바로 엽니다. 녹화 중 중단 버튼을 우클릭하거나 SimpleCapGIF에 포커스가 있을 때 **Esc**를 누르면 저장하지 않고 취소합니다.
