...
public sealed record CaptureRequest(PixelRect Region, PixelSize OutputSize, int FramesPerSecond, string SessionDirectory);
public sealed record CaptureStatistics(TimeSpan Elapsed, long FramesWritten, long BytesWritten, TimeSpan EncoderBacklog);
